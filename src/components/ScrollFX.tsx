 ...
 *
 * Živi u layout-u, pa ga navigacija ne remountuje: bez ponovnog skeniranja na
 * promenu rute ovo bi zakačilo samo elemente prve učitane stranice, a svaka
 * sledeća ruta ostala bi bez parallaxa i skew-a. Otud pathname u
 * dependencies + revertOnUpdate, koji pokupi trigere stare rute.
 */
